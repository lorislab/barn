 ...
 */
package org.lorislab.barn.adapter.jackson;
 ...
 */
@MetaInfServices
public class AttributeRestEasyAdapterService implements AttributeAdapterService {

    private static final Logger LOGGER = Logger.getLogger(AttributeRestEasyAdapterService.class.getName());
